...
write_env_file() {
  ...
  # Preserve existing secrets on re-deploy
...
ENABLE_DOCS=false
LOG_LEVEL=warning
CORS_ORIGINS=["http://localhost:$APP_PORT","http://127.0.0.1:$APP_PORT","http://${APP_HOST:-0.0.0.0}:$APP_PORT"]

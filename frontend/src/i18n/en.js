export default {
  ...
  visualizer: {
    ...
    boxIntegrateMode: 'Box Integration',
    boxIntegrateHint: 'Drag on the image to draw a rectangle. Release to integrate and list Miller indices inside.',
    boxPanHint: 'Shift + drag to pan; wheel to zoom.',
    recomputeBox: 'Recompute',
    clearBox: 'Clear Box',
    boxInfo: 'Box: {w}×{h} px',
    millerInBox: 'Miller pts in box',
    boxProfile: 'Box Integration Profile',
    boxMillerList: 'Miller Indices in Box',
    xAxisQ: 'q (Å⁻¹)',
    xAxis2theta: '2θ (°)',
    xAxisD: 'd (Å)',
    exportProfileCsv: 'Export CSV',
    exportMillerTxt: 'Export TXT',
    noMillerInBox: 'No Miller indices fall inside the box',
    intensity: 'Intensity',
    source: 'Source',
    boxIntegrateFailed: 'Box integration failed',
    boxThreshold: 'Threshold (filter bad pixels)',
    boxThreshMin: 'Min',
    boxThreshMax: 'Max',
    ...
    hdf5SelectTitle: 'Select HDF5 Dataset & Slice',
    hdf5SelectPrompt: 'HDF5 file loaded — select a dataset and slice',
    hdf5NoExtraAxes: 'This dataset is 2D — no extra axes to slice. Load directly.',
    hdf5Axis: 'Axis',
    hdf5ModeIndex: 'Frame index',
    hdf5ModeMax: 'Max projection',
    hdf5ModeSum: 'Sum projection',
    hdf5ModeMean: 'Mean projection',
    hdf5ProjectionHint: '(aggregated along this axis)',
    hdf5Load: 'Load Slice',
    hdf5ProbeFailed: 'HDF5 probe failed',
    hdf5LoadFailed: 'HDF5 slice load failed'
  },
  about: {
    title: 'About',
